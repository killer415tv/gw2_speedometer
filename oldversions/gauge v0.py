...
class Meter(tk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.numero = tk.Label(self, textvariable = self.var, fg = "black", bg="white", font=("Courier", 44, "bold")).place(x = 63, y = 60)
        ...
        self.canvas.create_arc(10, 10, 190, 190, extent=108, start=36,
                               style='arc', outline=color, width="10", tags="arc")

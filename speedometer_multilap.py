        ...
        if _lastTime + timer <= _time and _tick != _lastTick and _pos != _lastPos :
            ...
            if show_checkpoints_window: 
                ...
                if guildhall_name.get() == "DRFT-3 Summers Sunset":
                    checkpoint(0,"start",[-170.93539428710938,1.326380968093872,163.96417236328125])
                    checkpoint(1,"*",[3.4815573692321777,-0.029108256101608276,219.9225311279297])
                    checkpoint(2,"*",[331.5875244140625,13.986811637878418,196.99093627929688])
                    checkpoint(3,"*",[517.1841430664062,-0.45586901903152466,190.9269561767578])
                    checkpoint(4,"*",[689.4840698242188,0.1491001695394516,162.9842529296875])
                    checkpoint(5,"*",[610.6405639648438,1.0427699089050293,-25.819978713989258])
                    checkpoint(6,"*",[626.0570678710938,4.46407413482666,-281.3419494628906])
                    checkpoint(7,"*",[592.443359375,-0.2331160455942154,-449.8894958496094])
                    checkpoint(8,"*",[386.33087158203125,-0.5329235196113586,-852.8768920898438])
                    checkpoint(9,"*",[80.68055725097656,-0.5403383374214172,-966.6027221679688])
                    checkpoint(10,"*",[-217.603759765625,-0.49709755182266235,-772.9103393554688])
                    checkpoint(11,"*",[-431.9198303222656,-0.45414412021636963,-550.5722045898438])
                    checkpoint(12,"*",[-411.66680908203125,5.779642581939697,-234.1124725341797])
                    checkpoint(13,"*",[-154.45156860351562,2.7358055114746094,-73.90261840820312])
                    checkpoint(14,"end",[-165.48402404785156,3.461456537246704,127.8927230834961])
                    checkTP([-168.791015625,3.3922200202941895,145.42111206054688])

                if guildhall_name.get() == "DRFT-4 Mossheart Memory":
                    checkpoint(0,"start",[678.0431518554688,51.12827682495117,-553.8036499023438])
                    checkpoint(1,"*",[870.9617309570312,28.136838912963867,-394.934326171875])
                    checkpoint(2,"*",[762.9915161132812,28.60567855834961,-401.00079345703125])
                    checkpoint(3,"*",[322.7422180175781,33.50680923461914,-408.2164611816406])
                    checkpoint(4,"*",[-135.2315673828125,1.119834303855896,-312.72442626953125])
                    checkpoint(5,"*",[-351.4903564453125,43.48114776611328,-91.70638275146484])
                    checkpoint(6,"*",[275.26617431640625,28.402389526367188,-423.0520935058594])
                    checkpoint(7,"end",[657.280029296875,50.95335006713867,-581.0737915039062])
                    checkTP([706.5450439453125,45.9715461730957,-566.9035034179688])

                if guildhall_name.get() == "DRFT-5 Roller Coaster Canyon":
                    checkpoint(0,"start",[268.03546142578125,42.39094543457031,407.3761291503906])
                    checkpoint(1,"*",[-116.70823669433594,33.380794525146484,362.2879943847656])
                    checkpoint(2,"*",[-6.522019863128662,113.79924774169922,80.55506896972656])
                    checkpoint(3,"*",[204.29071044921875,47.2064323425293,2.6199214458465576])
                    checkpoint(4,"*",[286.7492370605469,75.55101776123047,-132.9562530517578])
                    checkpoint(5,"*",[780.190673828125,80.6693344116211,-244.0140838623047])
                    checkpoint(6,"*",[860.9737548828125,-0.30306902527809143,153.9273681640625])
                    checkpoint(7,"*",[875.045166015625,-0.3113495409488678,403.1307678222656])
                    checkpoint(8,"*",[1079.69677734375,13.441140174865723,431.2515869140625])
                    checkpoint(9,"*",[780.6974487304688,41.4215087890625,474.5398254394531])
                    checkpoint(10,"end",[303.5571594238281,44.21235275268555,412.75262451171875])
                    checkTP([293.8518371582031,44.28419876098633,411.35528564453125])

                if guildhall_name.get() == "DRFT-6 Centurion Circuit":
                    checkpoint(0,"start",[76.28065490722656,169.1909637451172,144.83230590820312])
                    checkpoint(1,"*",[139.76148986816406,139.68624877929688,449.4720764160156])
                    checkpoint(2,"*",[-24.009817123413086,143.63339233398438,475.8264465332031])
                    checkpoint(3,"*",[-269.9059753417969,62.47275924682617,506.369873046875])
                    checkpoint(4,"*",[-174.98696899414062,6.439240455627441,314.0978088378906])
                    checkpoint(5,"*",[-289.589111328125,4.047126770019531,-95.59497833251953])
                    checkpoint(6,"*",[-72.5886459350586,14.921908378601074,-144.85104370117188])
                    checkpoint(7,"*",[-20.654233932495117,102.74556732177734,-4.693610668182373])
                    checkpoint(8,"end",[59.449832916259766,168.59854125976562,132.0313720703125])
                    checkTP([102.72102355957031,168.95913696289062,109.9081039428711])

                if guildhall_name.get() == "DRFT-7 Dredgehaunt Cliffs":
                    checkpoint(0,"start",[-100.51851654052734,59.61595916748047,-614.6519165039062])
                    checkpoint(1,"*",[-350.8224792480469,82.69532012939453,-604.1018676757812])
                    checkpoint(2,"*",[-306.4831237792969,39.892425537109375,-724.8510131835938])
                    checkpoint(3,"*",[-41.60877227783203,58.75558853149414,-792.2735595703125])
                    checkpoint(4,"*",[169.4384765625,67.86759185791016,-487.4747009277344])
                    checkpoint(5,"*",[-32.68693161010742,61.246700286865234,-554.571044921875])
                    checkpoint(6,"end",[-108.16015625,55.61377716064453,-598.18505859375])
                    checkTP([-64.9792251586914,71.77044677734375,-642.0835571289062])

                if guildhall_name.get() == "DRFT-8 Icy Rising Ramparts":
                    checkpoint(0,"start",[627.6768188476562,60.982112884521484,536.5850219726562])
                    checkpoint(1,"*",[765.68603515625,65.68448638916016,306.9510803222656])
                    checkpoint(2,"*",[784.914306640625,51.462947845458984,53.37437438964844])
                    checkpoint(3,"*",[127.5890884399414,52.301292419433594,50.387367248535156])
                    checkpoint(4,"*",[216.4332733154297,76.55440521240234,228.186279296875])
                    checkpoint(5,"end",[686.406494140625,57.82354736328125,385.6000061035156])
                    checkTP([633.9191284179688,67.76505279541016,559.6528930664062])
                if guildhall_name.get() == "DRFT-9 Soulthirst Savannah of Svanier":
                    checkpoint(0,"start",[735.8277587890625,140.58657836914062,220.61209106445312])
                    checkpoint(1,"*",[895.8507690429688,116.71907806396484,76.58780670166016])
                    checkpoint(2,"*",[901.8799438476562,75.39824676513672,-69.47977447509766])
                    checkpoint(3,"*",[691.9908447265625,105.68778228759766,-21.672054290771484])
                    checkpoint(4,"*",[926.540283203125,86.55267333984375,1.8782862424850464])
                    checkpoint(5,"*",[784.4473876953125,121.62500762939453,243.1215362548828])
                    checkpoint(6,"*",[734.2640380859375,128.72305297851562,258.1431884765625])
                    checkpoint(7,"end",[712.1317138671875,132.5193634033203,228.20298767089844])
                    checkTP([728.2770385742188,137.615966796875,194.83433532714844])

                if guildhall_name.get() == "DRFT-10 Toxic Turnpike":
                    checkpoint(0,"start",[489.5429382324219,32.60679626464844,567.91650390625])
                    checkpoint(1,"*",[426.76422119140625,31.117679595947266,733.2987670898438])
                    checkpoint(2,"*",[261.7900085449219,18.585243225097656,714.3299560546875])
                    checkpoint(3,"*",[271.89154052734375,4.198031902313232,314.4117736816406])
                    checkpoint(4,"*",[389.604248046875,63.566314697265625,54.333213806152344])
                    checkpoint(5,"*",[608.3191528320312,69.05184936523438,60.75606155395508])
                    checkpoint(6,"*",[627.843505859375,80.11015319824219,369.96185302734375])
                    checkpoint(7,"end",[505.90802001953125,33.05876541137695,534.2535400390625])
                    checkTP([487.2627868652344,36.89270782470703,537.1104125976562])

                if guildhall_name.get() == "DRFT-11 Estuary of Twilight":
                    checkpoint(0,"start",[-158.9280548095703,26.854663848876953,712.0057373046875])
                    checkpoint(1,"*",[-62.26451110839844,10.789408683776855,940.8676147460938])
                    checkpoint(2,"*",[192.13864135742188,30.291471481323242,1071.877685546875])
                    checkpoint(3,"*",[248.65872192382812,9.293210983276367,942.4642333984375])
                    checkpoint(4,"*",[-49.85524368286133,4.999215602874756,1056.5546875])
                    checkpoint(5,"*",[-238.7691192626953,0.507969081401825,1026.8238525390625])
                    checkpoint(6,"*",[-183.7819061279297,18.439666748046875,672.4966430664062])
                    checkpoint(7,"end",[-159.95220947265625,28.90363121032715,679.1232299804688])
                    checkTP([-162.59605407714844,27.052156448364258,648.0520629882812])

                if guildhall_name.get() == "DRFT-12 Celedon Circle":
                    checkpoint(0,"start",[-97.07324981689453,2.1909596920013428,-991.5286254882812])
                    checkpoint(1,"*",[104.67520141601562,8.187158584594727,-1079.94091796875])
                    checkpoint(2,"*",[325.7801208496094,1.6837304830551147,-951.470947265625])
                    checkpoint(3,"*",[185.27833557128906,0.5170515775680542,-805.6868286132812])
                    checkpoint(4,"*",[44.27699661254883,16.001867294311523,-668.205078125])
                    checkpoint(5,"*",[-35.45330810546875,14.30510425567627,-708.71435546875])
                    checkpoint(6,"*",[-58.16525650024414,-0.3149067163467407,-910.8987426757812])
                    checkpoint(7,"end",[-103.46661376953125,0.7576069831848145,-969.575439453125])
                    checkTP([-115.86875915527344,0.9871450662612915,-984.7103881835938])

                if guildhall_name.get() == "DRFT-13 Thermo Reactor Escape":
                    checkpoint(0,"start",[214.17970275878906,34.77901840209961,262.64971923828125])
                    checkpoint(1,"*",[558.279296875,22.68880271911621,422.65399169921875])
                    checkpoint(2,"*",[180.23519897460938,38.744205474853516,460.99139404296875])
                    checkpoint(3,"*",[25.617855072021484,19.242494583129883,337.0907287597656])
                    checkpoint(4,"*",[-238.86732482910156,13.418222427368164,460.1061096191406])
                    checkpoint(5,"*",[-368.2333984375,22.580841064453125,691.6923217773438])
                    checkpoint(6,"*",[-312.4947509765625,8.23646068572998,844.6791381835938])
                    checkpoint(7,"*",[-226.2533416748047,8.482447624206543,740.9994506835938])
                    checkpoint(8,"*",[-66.81645965576172,11.934187889099121,326.6263732910156])
                    checkpoint(9,"*",[186.55453491210938,27.57809066772461,234.09915161132812])
                    checkpoint(10,"end",[197.55825805664062,33.35205841064453,253.68312072753906])
                    checkTP([170.61231994628906,32.02573013305664,255.3268280029297])
                    
                if guildhall_name.get() == "DRFT-14 Jormags Jumpscare":
                    checkpoint(0,"start",[733.29833984375,130.61166381835938,798.1470336914062])
                    checkpoint(1,"*",[567.7418212890625,49.79065704345703,467.09051513671875])
                    checkpoint(2,"*",[169.1837615966797,41.01500701904297,324.2213134765625])
                    checkpoint(3,"*",[139.72549438476562,62.498329162597656,-162.11167907714844])
                    checkpoint(4,"*",[156.9995880126953,113.64322662353516,-537.7450561523438])
                    checkpoint(5,"*",[292.5667724609375,102.19764709472656,-674.80517578125])
                    checkpoint(6,"*",[313.8788146972656,92.58746337890625,-444.7699890136719])
                    checkpoint(7,"*",[342.3179626464844,121.8738021850586,-246.27706909179688])
                    checkpoint(8,"*",[430.84716796875,73.1112289428711,-58.046566009521484])
                    checkpoint(9,"*",[553.2225952148438,18.335302352905273,291.4710998535156])
                    checkpoint(10,"*",[669.5028686523438,37.44054412841797,425.2445983886719])
                    checkpoint(11,"end",[610.7672119140625,50.10182571411133,475.6898193359375])
                    checkTP([740.2930297851562,133.31787109375,817.227783203125])

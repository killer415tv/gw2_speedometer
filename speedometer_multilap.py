        ...
        if _lastTime + timer <= _time and _tick != _lastTick and _pos != _lastPos :
            ...
            if show_checkpoints_window: 
                ...
                if guildhall_name.get() == "DRFT-GP-3 Inquest Isle Invasion":
                    ...
                    checkpoint(2,"end",[255.0358123779297,0.22395652532577515,207.25062561035156])
                    ...
                    checkpoint(4,"*",[623.910400390625,1.7676323652267456,-258.8634338378906])
                    checkpoint(5,"*",[403.7969970703125,-0.18220704793930054,-529.399169921875])
                    checkpoint(6,"*",[271.2414855957031,-0.17951872944831848,-665.9658203125])
                    checkpoint(7,"*",[121.96299743652344,-0.06854145228862762,-919.15771484375])
                    checkpoint(8,"*",[-164.6346893310547,-0.5259702801704407,-897.583740234375])
                    checkpoint(9,"*",[-284.7673034667969,-0.2441703826189041,-693.8151245117188])
                    checkpoint(10,"*",[-472.6644592285156,-0.30145934224128723,-370.4263000488281])
                    checkpoint(11,"end",[-223.18630981445312,0.7399634122848511,-81.19659423828125])

    ...
    def updateMeterTimer(self):
        ...
        if _lastTime + timer <= _time and _tick != _lastTick and _pos != _lastPos :
            ...
            if show_checkpoints_window: 
                ...
                if guildhall_name.get() == "DRFT-15 Triple Trek - Amber Ambush":
                    checkpoint(0,"start",[199.6152496,9.509608269,-90.13062286])
                    checkpoint(1,"*",[339.8240662,2.58372283,-96.59111786])
                    checkpoint(2,"*",[543.5795288,33.92137909,-186.0417328])
                    checkpoint(3,"*",[498.1088867,28.78915405,-369.5389099])
                    checkpoint(4,"*",[390.9669495,15.90636539,-469.4672241])
                    checkpoint(5,"*",[326.4246826,3.018717289,-597.8221436])
                    checkpoint(6,"*",[257.3063965,32.3952713,-489.0424194])
                    checkpoint(7,"*",[183.9393158,30.89782906,-371.1974792])
                    checkpoint(8,"*",[90.49740601,33.77570343,-322.5493164])
                    checkpoint(9,"*",[-4.298639774,34.04431534,-331.3991089])
                    checkpoint(10,"*",[-9.627020836,57.35002899,-189.0332184])
                    checkpoint(11,"*",[23.33789825,36.08519745,-101.6923447])
                    checkpoint(12,"*",[32.67592239,33.00643539,-186.4054871])
                    checkpoint(13,"*",[136.8313141,29.50439453,-267.742157])
                    checkpoint(14,"end",[180.6116486,16.85618973,-164.8156738])
                    checkpoint(-1,"reset",[150.477417,8.747236252,-92.15884399])

                if guildhall_name.get() == "DRFT-16 Triple Trek - Cobalt Catastrophe":
                    checkpoint(0,"start",[141.3429565,3.914337635,-49.48170471])
                    checkpoint(1,"*",[-18.40257835,3.138510704,-12.08532619])
                    checkpoint(2,"*",[-103.0023193,6.779664993,-119.1855469])
                    checkpoint(3,"*",[-168.870697,6.175187588,-266.7835999])
                    checkpoint(4,"*",[-136.7376556,8.96985054,-356.4486694])
                    checkpoint(5,"*",[-64.27145386,22.55521393,-397.5758972])
                    checkpoint(6,"*",[-5.004066944,34.38972092,-330.4241943])
                    checkpoint(7,"*",[-16.04692459,57.00086594,-211.4869843])
                    checkpoint(8,"*",[-64.29258728,65.11290741,-331.4292603])
                    checkpoint(9,"*",[-6.249106884,63.60621262,-407.1000366])
                    checkpoint(10,"*",[101.0001526,49.33917999,-436.5431519])
                    checkpoint(11,"*",[254.5966644,31.75820351,-486.6627502])
                    checkpoint(12,"*",[319.4411926,2.191658735,-602.2543335])
                    checkpoint(13,"*",[369.6866455,8.294520378,-523.6633911])
                    checkpoint(14,"*",[303.9490051,29.73707581,-460.4508057])
                    checkpoint(15,"*",[181.1721497,30.9468708,-366.2435303])
                    checkpoint(16,"*",[108.4886398,32.95768738,-324.3365173])
                    checkpoint(17,"*",[18.84648705,34.30450439,-332.8678589])
                    checkpoint(18,"*",[95.27376556,44.03229141,-290.1904907])
                    checkpoint(19,"*",[160.5135193,24.83011436,-243.3605499])
                    checkpoint(20,"end",[176.0186462,15.73690414,-152.4803772])
                    checkpoint(-1,"reset",[183.6887512,9.464728355,-77.97341156])

                if guildhall_name.get() == "DRFT-17 Triple Trek - Crimson Chaos":
                    checkpoint(0,"start",[164.40884399414062,11.436594009399414,-119.54751586914062])
                    checkpoint(1,"*",[244.04696655273438,32.38958740234375,-233.8712921142578])
                    checkpoint(2,"*",[241.17147827148438,59.27178955078125,-302.8828125])
                    checkpoint(3,"*",[126.70991516113281,46.59769821166992,-423.1141662597656])
                    checkpoint(4,"*",[3.763288736343384,62.96494674682617,-421.2530517578125])
                    checkpoint(5,"*",[-60.09884262084961,67.080078125,-358.8787536621094])
                    checkpoint(6,"*",[-14.92410659790039,56.99648666381836,-212.24459838867188])
                    checkpoint(7,"*",[14.960681915283203,59.74909973144531,-286.0865783691406])
                    checkpoint(8,"*",[-106.10549926757812,15.373141288757324,-429.371337890625])
                    checkpoint(9,"*",[-68.1506118774414,7.742080211639404,-523.9627075195312])
                    checkpoint(10,"*",[89.70743560791016,2.8447206020355225,-605.5836181640625])
                    checkpoint(11,"*",[245.8296661376953,3.862854242324829,-572.7655029296875])
                    checkpoint(12,"*",[372.70355224609375,9.335136413574219,-509.56719970703125])
                    checkpoint(13,"*",[367.0718078613281,34.73117446899414,-377.8245544433594])
                    checkpoint(14,"*",[342.0904235839844,41.44921112060547,-258.7257995605469])
                    checkpoint(15,"*",[442.5415344238281,12.261510848999023,-110.21143341064453])
                    checkpoint(16,"*",[341.5835876464844,2.2520415782928467,-95.9219741821289])
                    checkpoint(17,"end",[217.15728759765625,8.513725280761719,-96.43672943115234])
                    checkpoint(-1,"reset",[152.18002319335938,8.798792839050293,-92.12249755859375])
                if guildhall_name.get() == "DRFT-18 Triple Trek - Medley":
                    checkpoint(0,"start",[207.3510437,9.050430298,-93.10125732])
                    checkpoint(1,"*",[342.5205078,2.159646511,-96.29367065])
                    checkpoint(2,"*",[543.0581055,33.90119553,-184.5549316])
                    checkpoint(3,"*",[500.3311462,28.92171288,-367.8606262])
                    checkpoint(4,"*",[392.8687744,16.65350533,-465.3461609])
                    checkpoint(5,"*",[328.3372192,2.786030293,-600.9354248])
                    checkpoint(6,"*",[257.1685181,32.23954773,-490.6486206])
                    checkpoint(7,"*",[180.2850952,30.90820313,-366.6773071])
                    checkpoint(8,"*",[76.95513916,33.48414993,-325.1487122])
                    checkpoint(9,"*",[-4.611003399,34.38502502,-330.601532])
                    checkpoint(10,"*",[-9.746717453,57.28764725,-188.5516205])
                    checkpoint(11,"*",[28.5077343,35.05901337,-99.89382172])
                    checkpoint(12,"*",[32.50809097,32.99386978,-185.7158661])
                    checkpoint(13,"*",[137.2178192,28.54396439,-264.5100403])
                    checkpoint(14,"*",[165.1867218,11.4988699,-121.135849])
                    checkpoint(15,"*",[227.6891327,30.28076744,-221.2533264])
                    checkpoint(16,"*",[243.0948944,59.19993591,-302.7789917])
                    checkpoint(17,"*",[122.0008011,47.59330368,-425.5993347])
                    checkpoint(18,"*",[-4.026248455,63.4796524,-413.7335205])
                    checkpoint(19,"*",[-66.25790405,66.29660034,-346.0257568])
                    checkpoint(20,"*",[-21.73764992,57.02035522,-211.8051758])
                    checkpoint(21,"*",[14.32081985,59.74909973,-288.2478333])
                    checkpoint(22,"*",[-106.7274933,15.18790722,-430.2991943])
                    checkpoint(23,"*",[-68.84357452,7.403268337,-525.1192017])
                    checkpoint(24,"*",[92.55758667,2.894106627,-602.9929199])
                    checkpoint(25,"*",[243.0776672,3.369976044,-572.2714233])
                    checkpoint(26,"*",[371.1045227,9.492781639,-508.8040161])
                    checkpoint(27,"*",[358.0822754,37.21830368,-376.9918518])
                    checkpoint(28,"*",[345.9256287,40.94925308,-257.7312317])
                    checkpoint(29,"*",[444.1765137,12.23444653,-101.1178589])
                    checkpoint(30,"*",[345.2121277,1.914018631,-96.38175964])
                    checkpoint(31,"*",[138.9543152,2.962664604,-43.8376503])
                    checkpoint(32,"*",[-16.04640388,2.757231474,-7.436340332])
                    checkpoint(33,"*",[-99.89842987,5.678984642,-111.9434586])
                    checkpoint(34,"*",[-168.0984039,6.216689587,-264.4488831])
                    checkpoint(35,"*",[-137.5038452,8.809866905,-356.2485046])
                    checkpoint(36,"*",[-61.12171555,23.36486244,-392.3157959])
                    checkpoint(37,"*",[-6.389362335,33.54698944,-332.0065613])
                    checkpoint(38,"*",[-20.17896461,56.97404099,-214.7263794])
                    checkpoint(39,"*",[-66.12608337,66.19732666,-343.4112244])
                    checkpoint(40,"*",[-7.042713165,63.56595612,-410.8849182])
                    checkpoint(41,"*",[118.5577545,48.16658401,-427.3621216])
                    checkpoint(42,"*",[256.1228943,32.27584076,-489.1769104])
                    checkpoint(43,"*",[326.9819946,2.898291111,-598.9110107])
                    checkpoint(44,"*",[370.4710083,9.002178192,-510.7716675])
                    checkpoint(45,"*",[306.0106812,30.01830292,-459.0186768])
                    checkpoint(46,"*",[182.7348938,30.82492447,-368.0265198])
                    checkpoint(47,"*",[117.1386871,32.9045639,-327.1153259])
                    checkpoint(48,"*",[20.95863533,34.51299667,-334.3122864])
                    checkpoint(49,"*",[84.54663086,43.93395996,-298.0310364])
                    checkpoint(50,"*",[165.3105469,25.03772163,-236.5727081])
                    checkpoint(51,"end",[175.4340515,15.59510422,-151.4719696])
                    checkpoint(-1,"reset",[196.5098267,20.48235321,-124.2293472])
...
class Racer():
    ...
    def __init__(self):
        ...
        self.t_1 = tk.Label(self.root, text="""Race Assistant v1.7.14""", justify = tk.LEFT, padx = 20, fg = self.fg.get(), bg=self.bg.get(), font=("Lucida Console", 15))
        ...
        self.choices = ['None, im free!', "OLLO Akina", 'RACE Downhill', 'RACE Hillclimb', 'RACE Full Mountain Run', 
            ...
            "DRFT-15 Triple Trek - Amber Ambush", "DRFT-16 Triple Trek - Cobalt Catastrophe", "DRFT-17 Triple Trek - Crimson Chaos", "DRFT-18 Triple Trek - Medley",
